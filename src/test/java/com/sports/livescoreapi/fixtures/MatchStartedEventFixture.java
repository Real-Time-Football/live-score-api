...
public class MatchStartedEventFixture {

    public static MatchStartedEventBuilder aMatchStartedEvent() {
        return new MatchStartedEventBuilder();
    }

    public static class MatchStartedEventBuilder {
